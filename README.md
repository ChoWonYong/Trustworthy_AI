...
* `results/`: A directory where the original images, adversarial images, and 10x magnified perturbation visualization results are saved (automatically generated when `test.py` is executed).
